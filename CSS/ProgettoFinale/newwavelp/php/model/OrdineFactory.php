...
class OrdineFactory {
    ...
    */       
    ...
    /*
    * La funzione calcola il prezzo totale dell'ordine
    ...
    */     
    ...
    public function creaOrdineDaArray($row) {
        ...
        $ordine->setAddettoOrdini($row['admin_id']);    
        return $ordine;
    }
    ...
    */   
    public function getOrdiniPerData($data){
        ...
        //la forma della data per la query
        
       $mysqli = Db::getInstance()->connectDb();
        if (!isset($mysqli)) {
            error_log("[ricercaPerData] impossibile inizializzare il database");
            $mysqli->close();
            return 0;
        }
