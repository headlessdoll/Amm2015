...
class BaseController {
    ...
    protected function showHomeCliente($vd) {
        ...
        $vd->setTitolo("NewWaveLP - gestione cliente ");
    ...
    protected function showHomeAddettoOrdini($vd) {
        ...
        $vd->setTitolo("NewWaveLP - gestione addetto ordini");
        $vd->setMenuFile(basename(__DIR__) . '/../view/admin/menu.php');
        $vd->setLogoFile(basename(__DIR__) . '/../view/admin/logo.php');
        $vd->setLeftBarFile(basename(__DIR__) . '/../view/admin/leftBar.php');
